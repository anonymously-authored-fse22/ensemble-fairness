...
#data <- read.csv("C:/Users/lakda/Desktop/Analytics/Term 2/Data Mining/german_credit_data (3).csv")
data <-  read.csv("../input/german-data-original/german_credit_data (3).csv")
```
...
#cleanData <- read.csv("filename.csv")
cleanData <- read.csv("../input/german-dataset-cleaned/filename.csv")
```
...
```{r}
smote <- read.csv("../input/german-dataset-cleaned/filename.csv")
