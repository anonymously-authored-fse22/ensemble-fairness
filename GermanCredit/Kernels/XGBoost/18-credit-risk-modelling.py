...
# <h1>Welcome to my Kernel ! 
# 
# </h1><h2>I will be performing some Exploratory Data Analysis on the German Credit Risk Datase to understand the distribuitions and patterns in the behavior of consumers.</h2>
